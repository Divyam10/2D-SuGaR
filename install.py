...
if __name__ == '__main__':
    ...
    print("[INFO] Creating the conda environment for 2d-sugar...")
    os.system("conda env create -f environment.yml")
    print("[INFO] Conda environment created.")

    # Install 2D Gaussian Splatting rasterizer
    print("[INFO] Installing the 2D Gaussian Splatting rasterizer...")
    os.chdir("gaussian_splatting_2d/submodules/diff-surfel-rasterization/")
    os.system("conda run -n 2d-sugar pip install -e .")
    print("[INFO] 2D Gaussian Splatting rasterizer installed.")
    ...
    if args.no_nvdiffrast:
        ...
        os.chdir("nvdiffrast")
        os.system("conda run -n 2d-sugar pip install .")
    ...
    print("[INFO] 2d-sugar installation complete.")
