...
def cull_scan(scan, mesh_path, result_mesh_file, instance_dir):
    ...
    # print("Intrinsics:", intrinsics_all[0])
    # print("Pose:", pose_all[0])
    # print("Camera_mat_0:", camera_dict["camera_mat_0"])
    # print("Extrinsics:", camera_dict["world_mat_0"])
    # print("Scale:", camera_dict["scale_mat_0"])
    ...
    # avg_position = vertices.mean(axis=0)
    # print("Average vertex position (unculled):", avg_position)
    ...
    # avg_position = mesh.vertices.mean(axis=0)
    # print("Average vertex position (culled, before scaling):", avg_position)
    
    # transform vertices to world 
    scale_mat = scale_mats[0]
    mesh.vertices = mesh.vertices * scale_mat[0, 0] + scale_mat[:3, 3][None]

    # print("Scale matrix 0:", scale_mats[0])
    # print("Scale matrix 1:", scale_mats[1])
    #
    # avg_position = mesh.vertices.mean(axis=0)
    # print("Average vertex position (culled):", avg_position)
