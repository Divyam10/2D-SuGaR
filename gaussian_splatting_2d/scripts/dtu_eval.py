...
if not args.skip_training:
    common_args = "--quiet --test_iterations -1 --depth_ratio 1.0 -r 2 --lambda_dist 1000 --save_iterations 1 7000 30000 --iterations 30000 --cluster_prune_iterations 7000 --initialization_prior monocular_depth_normal"
